...
7. Create the pull request with an explicit repo:
   - **GitHub MCP:** `owner=sergey-zinchenko`, `repo=vscode`, `base=main`
   - **`gh` CLI:** `gh pr create --repo sergey-zinchenko/vscode --base main ...`
